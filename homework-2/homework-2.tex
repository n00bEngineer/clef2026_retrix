...
%% the work being presented. Separate the keywords with commas.
  \begin{keywords}
    Fact Checking \sep Scientific Document Retrieval \sep Social Media Fact Verification \sep Neural Reranking \sep CLEF \sep Information Retrieval \sep Cross Encoder
